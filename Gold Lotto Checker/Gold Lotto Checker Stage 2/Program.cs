...
namespace Gold_Lotto_Checker_Stage_2 {
    ...
    ///and randomly generated unique drawn numbers then 
    ///displays all numbers in the console as well as 
    ///how many winning and supplementary
    ...
    class Program {
        ...
        /// <summary>
        /// 
        /// Generates random unique numbers to be used as the 
        ///winning/supplementary numbers
        /// 
        /// </summary>
        /// <returns>Array of winning and supplementary numbers</returns>

        static int[] GetDrawNumbers(){
            ...
            for (int i = 0; i <=7; i++) {
                if (i > 0){
                    ...
                    while (repeat) {
                        bool copy = false;
                        addition = randomValue.Next(1,46);
                        for (int j = 0; j <= i-1; j++) {
                            if (addition == draws[j]) {
                                copy = true;
                            }
